...
public class BeerOrderManagerImplIT {
    ...
    void testAllocatedToCancel() throws JsonProcessingException {
        ...
        DeallocateOrderRequest deallocationFailureEvent = (DeallocateOrderRequest) jmsTemplate.receiveAndConvert(JmsConfig.DEALLOCATE_ORDER_QUEUE);

        assertNotNull(deallocationFailureEvent);
        assertThat(deallocationFailureEvent.getBeerOrderDto().getId()).isEqualTo(savedBeerOrder.getId());
    }
